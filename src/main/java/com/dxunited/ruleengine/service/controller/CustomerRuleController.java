...
import com.dxunited.ruleengine.service.response.GenericResponse;
import com.dxunited.ruleengine.service.service.RuleEngineService;
import com.dxunited.ruleengine.service.exception.SzRuleEngineRestException;
...
//        logger.info("Entered into getCustomer@CustomerController");
        ...
        try {
            ...
            throw new SzRuleEngineRestException(HttpStatus.BAD_REQUEST, HttpStatus.BAD_REQUEST.value(),
                    "Error occurred while fetching the record : ", ex.getMessage());
        }
    ...
    @PostMapping("/project/runrule")
    public ResponseEntity<Object> runRUleRecordForSpecificProject(@RequestBody String query) {
